...
def get_supabase_auth() -> Client:
    """Cliente Supabase fresco para el exchange OAuth. No necesita estado previo porque
    el code_verifier se pasa explícitamente desde los query params del redirect."""
